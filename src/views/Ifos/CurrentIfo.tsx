    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="https://pancakeswap.finance/swap#/swap?inputCurrency=0xbf151f63d8d1287db5fc7a3bc104a9c38124cdeb" mr="16px">
              {TranslateString(999, 'Buy AVN')}
            </LinkExternal>
            <LinkExternal href="https://swap.avnswap.finance/#/add/ETH/0xbf151f63d8d1287db5fc7a3bc104a9c38124cdeb">
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with AVNRich, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
              href="https://t.me/Avnrich_Support"
              external
            >
